...
Given(
  'that the registry admin user has a set of properly schema-formatted data',
  () => {
...
When(
  'the registry admin user submits an API key and a request to bulk upload the data to the entity registry',
  () => {
